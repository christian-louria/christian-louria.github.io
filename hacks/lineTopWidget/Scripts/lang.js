...
if (Lang == "cz") {
    ...
    var oneletterdays = ["N", "P", "Ú", "S", "Č", "P.", "S."];
...
if (Lang == "it") {
    ...
    var oneletterdays = ["S", "M", "Ma", "Me", "G", "V", "S."];
...
if (Lang == "ca") {
    ...
    var oneletterdays = ["S", "Mo", "Ma", "Mi", "J", "V", "S."];
...
if (Lang == "de") {
    ...
    var oneletterdays = ["S", "M", "D", "M.", "D.", "F", "S."];
...
if (Lang == "fr") {
    ...
    var oneletterdays = ["D", "L", "M", "M.", "J", "V", "S"];
...
if (Lang == "ru") {
    ...
    var oneletterdays = ["В", "П", "В.", "С", "Ч", "П.", "С."];
...
if (Lang == "pl") {
    ...
    var oneletterdays = ["N", "P", "W", "S", "C", "P.", "S."];
...
if (Lang == "pt") {
    ...
    var oneletterdays = ["D", "S", "T", "Q", "Q.", "S.", "Sá"];
...
if (Lang == "no") {
    ...
    var oneletterdays = ["S", "M", "T", "O", "T.", "F", "L"];
...
if (Lang == "nl") {
    ...
    var oneletterdays = ["Z", "M", "D", "W", "D.", "V", "Z."];
...
if (Lang == "fi") {
    ...
    var oneletterdays = ["S", "M", "T", "K", "T.", "P", "L"];
