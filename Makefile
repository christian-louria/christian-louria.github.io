all:
	...
	fpm -s dir -t deb -n animweatherHS -a iphoneos-arm -v 1.3.2 hacks/animweatherHS=/var/mobile/Library/SBHTML
	fpm -s dir -t deb -n animweatherLS -a iphoneos-arm -v 1.1 hacks/animweatherLS=/var/mobile/Library/iWidgets
	fpm -s dir -t deb -n stacksLS -a iphoneos-arm -v 2.1 hacks/stacksLS=/var/mobile/Library/iWidgets
